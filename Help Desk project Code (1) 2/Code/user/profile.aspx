<%@ Page Language="C#" MasterPageFile="~/user/MasterPage.master" AutoEventWireup="true" CodeFile="profile.aspx.cs" Inherits="user_profile" Title="Untitled Page" %>
            ...
            <table style="width: 366px; height: 329px">
                ...
                <tr>
                    ...
                    <td style="width: 76px">
                        <asp:Label ID="Label1" runat="server" Font-Bold="True" 
                            Text='<%# Eval("nuid") %>' Width="98px"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td style="font-weight: bolder; font-size: 16px; background-color: #008000; width: 153px;">
                ...
                <tr style="color: #000000">
                    <td style="font-weight: bolder; font-size: 16px; background-color: #008000; width: 153px;">
                        Mail ID</td>
                    <td style="width: 76px">
                        <asp:Label ID="Label9" runat="server" style="font-weight: 700" Text='<%#Eval("mail")%>'></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td style="font-weight: bolder; font-size: 16px; background-color: #008000; width: 153px;">
