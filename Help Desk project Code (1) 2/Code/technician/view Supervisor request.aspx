<%@ Page Language="C#" MasterPageFile="~/technician/technician.master" AutoEventWireup="true" CodeFile="view Supervisor request.aspx.cs" Inherits="technician_view_Supervisor_request" Title="Untitled Page" %>
                ...
                <tr>
                    <td align="left" bgcolor="White">
                        <asp:LinkButton ID="LinkButton1" runat="server" 
                            CommandArgument='<%#Eval("rid") %>' CommandName="Send" style="font-weight: 700">Send Status</asp:LinkButton>
                    </td>
